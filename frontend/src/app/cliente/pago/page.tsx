          ...
          <div className="w-full max-w-3xl">
            <div className="flex items-center">
              <div className="flex-1 text-center">
                <div className="w-10 h-10 mx-auto rounded-full bg-[#048BA8] text-white flex items-center justify-center">
                  1
                </div>
                <div className="mt-2 text-sm font-medium text-[#2E4057]">Revisar Carrito</div>
              </div>
              <div className="w-full h-1 bg-[#048BA8]"></div>
              <div className="flex-1 text-center">
                <div className="w-10 h-10 mx-auto rounded-full bg-[#048BA8] text-white flex items-center justify-center">
                  2
                </div>
                <div className="mt-2 text-sm font-medium text-[#2E4057]">Dirección de Envío</div>
              </div>
              <div className="w-full h-1 bg-[#048BA8]"></div>
              <div className="flex-1 text-center">
                <div className="w-10 h-10 mx-auto rounded-full bg-[#048BA8] text-white flex items-center justify-center">
                ...
                <div className="mt-2 text-sm font-medium text-[#2E4057]">Método de Pago</div>
              </div>
              <div className="w-full h-1 bg-gray-300"></div>
              <div className="flex-1 text-center">
                <div className="w-10 h-10 mx-auto rounded-full bg-gray-300 text-gray-600 flex items-center justify-center">
                  4
                </div>
                <div className="mt-2 text-sm font-medium text-gray-500">Confirmar Orden</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-lg shadow p-6 mb-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <input type="radio" id="tarjeta" name="pago" className="h-4 w-4 text-[#048BA8] focus:ring-[#048BA8]" checked />
